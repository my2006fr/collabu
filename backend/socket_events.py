...
# Initialized without app here — socketio.init_app(app, ...) is called in app.py
# This avoids a circular import (app.py imports socket_events, socket_events imports app)
